...
ACCOUNTS_CATALOG = {
    ...
    "acc_ph": {"name": "🇵🇭 Филиппины (+63)",          "price": "128.25", "stars": "300"},
    "acc_ng": {"name": "🇳🇬 Нигерия (+234)",           "price": "130.50", "stars": "300"},
    "acc_id": {"name": "🇮🇩 Индонезия (+62)",          "price": "141.75", "stars": "300"},
    "acc_pk": {"name": "🇵🇰 Пакистан (+92)",           "price": "144.00", "stars": "300"},
    "acc_cl": {"name": "🇨🇱 Чили (+56)",               "price": "177.75", "stars": "300"},
    "acc_ca": {"name": "🇨🇦 Канада (+1)",              "price": "193.50", "stars": "400"},
    "acc_ir": {"name": "🇮🇷 Иран (+98)",               "price": "218.25", "stars": "400"},
    "acc_eg": {"name": "🇪🇬 Египет (+20)",             "price": "222.75", "stars": "400"},
    "acc_mg": {"name": "🇲🇬 Мадагаскар (+261)",        "price": "245.25", "stars": "500"},
    "acc_np": {"name": "🇳🇵 Непал (+977)",             "price": "249.75", "stars": "500"},
    "acc_pe": {"name": "🇵🇪 Перу (+51)",               "price": "258.75", "stars": "500"},
    "acc_br": {"name": "🇧🇷 Бразилия (+55)",           "price": "261.00", "stars": "500"},
    ...
    "acc_uz": {"name": "🇺🇿 Узбекистан (+998)",        "price": "301.50", "stars": "600"},
    "acc_gb": {"name": "🇬🇧 Великобритания (+44)",     "price": "312.75", "stars": "600"},
    "acc_cu": {"name": "🇨🇺 Куба (+53)",               "price": "321.75", "stars": "600"},
    "acc_ye": {"name": "🇾🇪 Йемен (+967)",             "price": "324.00", "stars": "600"},
    ...
    "acc_mr": {"name": "🇲🇷 Мавритания (+222)",        "price": "375.75", "stars": "700"},
    "acc_ie": {"name": "🇮🇪 Ирландия (+353)",          "price": "384.75", "stars": "700"},
    "acc_tr": {"name": "🇹🇷 Турция (+90)",             "price": "420.75", "stars": "800"},
    "acc_it": {"name": "🇮🇹 Италия (+39)",             "price": "438.75", "stars": "800"},
    "acc_pl": {"name": "🇵🇱 Польша (+48)",             "price": "445.50", "stars": "800"},
    "acc_sa": {"name": "🇸🇦 Саудовская Аравия (+966)", "price": "445.50", "stars": "800"},
    "acc_fj": {"name": "🇫🇯 Фиджи (+679)",             "price": "447.75", "stars": "800"},
    "acc_hk": {"name": "🇭🇰 Гонконг (+852)",           "price": "477.00", "stars": "800"},
    "acc_jp": {"name": "🇯🇵 Япония (+81)",             "price": "479.25", "stars": "900"},
    "acc_at": {"name": "🇦🇹 Австрия (+43)",            "price": "488.25", "stars": "900"},
    "acc_pt": {"name": "🇵🇹 Португалия (+351)",        "price": "488.25", "stars": "900"},
    "acc_kw": {"name": "🇰🇼 Кувейт (+965)",            "price": "497.25", "stars": "900"},
    "acc_am": {"name": "🇦🇲 Армения (+374)",           "price": "542.25", "stars": "1000"},
    "acc_ee": {"name": "🇪🇪 Эстония (+372)",           "price": "549.00", "stars": "1000"},
    "acc_sg": {"name": "🇸🇬 Сингапур (+65)",           "price": "1930.50", "stars": "3300"},
}
